  ...
  return (
    <div>
        ...
        {genreList.map((item,index)=>(
            ...
            className={`flex gap-2 items-center mb-2 cursor-pointer hover:bg-gray-300 p-3 group rounded-lg hover:dark:bg-gray-600 ${activeIndex==index?'bg-gray-300 dark:bg-gray-600':null}`}>
